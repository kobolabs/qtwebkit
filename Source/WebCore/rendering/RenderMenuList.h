...
private:
    ...
    virtual int inlineBlockBaseline(LineDirectionMode direction, FontBaseline baselineType = AlphabeticBaseline) const OVERRIDE { return RenderBlock::inlineBlockBaseline(direction); }
